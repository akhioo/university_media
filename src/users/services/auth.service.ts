...
export class AuthService {
  ...
  public async signUp(signUpDTO: SignUpDTO): Promise<AuthenticatedUserInterface> {
  ...
  private async _proceedWithLogin(user: UserEntity): Promise<AuthenticatedUserInterface> {
